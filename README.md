...
(see Correctness summary above). MSE vs CPU unchanged, as expected -
the fix only touches the Python reference script.
...
bound. Over 99% of voxels agree to within 0.0046; median difference
4.94e-05.
