...
FILES = {
    # the professor-provided reference script (unmodified algorithm, random
    # jitter, sample_ratio=2), what grading means by "Reference code
    # (python)". 256^3 only -- hardcodes that dataset, no --data flag.
...
for name, v in volumes.items():
    ...
    if name == 'cpu':
        ...
        print(f"{name:<10} {mn:>10.4f} {mx:>10.4f} {me:>10.4f} {nan_c:>6} {inf_c:>6}  (topic2 ref, professor-provided)")
    elif nan_c or inf_c:
