...
& \texttt{gpu-buf} & 0.0000 & 1.7307 & 0.0067 & 0 / 0 & $6.436 \times 10^{-10}$ \\
& \texttt{gpu-img} & 0.0000 & 1.8741 & 0.0067 & 0 / 0 & $1.949 \times 10^{-7}$ \\
& \texttt{gpu-opt} & 0.0000 & 1.8741 & 0.0067 & 0 / 0 & $1.949 \times 10^{-7}$ \\
\midrule
$512^3$ & \texttt{cpu} & 0.0000 & 1.0055 & 0.0330 & 0 / 0 & (Reference) \\
& \texttt{gpu-buf} & 0.0000 & 1.0054 & 0.0330 & 0 / 0 & $9.087 \times 10^{-11}$ \\
& \texttt{gpu-img} & 0.0000 & 1.0054 & 0.0330 & 0 / 0 & $6.849 \times 10^{-10}$ \\
& \texttt{gpu-opt} & 0.0000 & 1.0054 & 0.0330 & 0 / 0 & $6.849 \times 10^{-10}$ \\
\bottomrule
\end{tabularx}
...
All GPU implementations match the CPU reference within float32 rounding tolerances, confirm zero invalid floating-point values, and maintain non-negativity across all epochs.
...
\begin{itemize}[noitemsep]
    \item Robust numerical accuracy validated at the float32 rounding floor ($\text{MSE} \le 1.95 \times 10^{-7}$).
