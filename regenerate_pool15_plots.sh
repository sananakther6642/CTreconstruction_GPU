...
# and retry_pool15_gpu_configs.sh do. Safe to run any time after confirming
...
if [ "$MISSING" -eq 1 ]; then
  ...
  echo "retry_pool15_gpu_configs.sh (or the missing run_one calls) first."
  exit 1
fi
